...
//        for(int i = 0; i< T
        ...
        for(All_vertices_iterator fit = T.all_vertices_begin();
            ...
            i++;
            if(i %10000 ==0){
                std::cout<<"has process "<< i <<std::endl;
            }
...
public:
    ...
    */
    ...
    {
        if(T.dimension() == 2){
            std::cout<<"T.dimension() == 2 "<<std::endl;
            deal_with_2d = true;
    ...
    */
    void run(double radius_ratio_bound=5, double beta= 0.52)
    {
        ...
        std::cout<<__func__<<" "<< "before initialize_vertices_and_cells"<<std::endl;
        initialize_vertices_and_cells();
        std::cout<<__func__<<" "<< "after initialize_vertices_and_cells"<<std::endl;
        bool re_init = false;
        std::cout<<__func__<<" "<< "before do while 1"<<std::endl;
        do
        {
        ...
        std::cout<<__func__<<" "<< "after do while 1"<<std::endl;
        std::cout<<__func__<<" "<< "before construct_surface"<<std::endl;
        _tds_2_inf = AFSR::construct_surface(_tds_2, *this);
        std::cout<<__func__<<" "<< "after construct_surface"<<std::endl;
